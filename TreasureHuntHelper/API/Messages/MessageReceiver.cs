...
namespace Cookie.API.Messages
{
    ...
    {
        private static readonly Dictionary<ushort, Func<NetworkMessage>> _constructors =
            new Dictionary<ushort, Func<NetworkMessage>>(800);

        private static readonly Dictionary<ushort, Type> _messages = new Dictionary<ushort, Type>(800);
