namespace Cookie.API.Protocol.Network.Types.Game.Context.Fight
{
    ...
    public class FightCommonInformations : NetworkType
    {
        ...
        public FightCommonInformations(ushort fightId, byte fightType, List<FightTeamInformations> fightTeams, List<ushort> fightTeamsPositions, List<FightOptionsInformations> fightTeamsOptions)
        {
            FightId = fightId;
            FightType = fightType;
